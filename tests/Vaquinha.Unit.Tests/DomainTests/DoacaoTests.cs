...
namespace Vaquinha.Unit.Tests.DomainTests
{
                              ...
                              IClassFixture<CartaoCreditoFixture>
    {
        ...
        [Fact] // A expressão "Fact" no xUnit indica um fato a ser testado
        [Trait("Doacao", "Doacao_CorretamentePreenchidos_DoacaoValida")] // Trait organiza o que vai ser testado
